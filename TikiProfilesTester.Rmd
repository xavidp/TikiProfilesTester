...
for (vv in 1:length(Versions)) {
  ...
  cat(paste0("\n* Version: ", Versions[vv], " -------------------------------------- \n"))
  Revision_string <- system(paste0("cd ", basepath, Versions[vv],";svn info | grep Revision"), intern=TRUE)
  Revision[vv] <- sub("Revision: ", "r", Revision_string, fixed=T)
