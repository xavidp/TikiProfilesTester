...
#    n1 <- nPlot(N.Errors ~ N, group = "Version", data = p.r, type = "multiBarChart")
    ...
    n2.all$save(file.path(getwd(), "results", format(Sys.Date(), "%y%m%d"), "issue_chart_all.html"), cdn = F)
    ...
    n2.12x$save(file.path(getwd(), "results", format(Sys.Date(), "%y%m%d"), "issue_chart_tiki12x.html"), cdn = F)
    ...
    n2.14x$save(file.path(getwd(), "results", format(Sys.Date(), "%y%m%d"), "issue_chart_tiki14x.html"), cdn = F)
    ...
    n2.15x$save(file.path(getwd(), "results", format(Sys.Date(), "%y%m%d"), "issue_chart_tiki15x.html"), cdn = F)
    ...
    n2.trunk$save(file.path(getwd(), "results", format(Sys.Date(), "%y%m%d"), "issue_chart_tikitrunk.html"), cdn = F)
